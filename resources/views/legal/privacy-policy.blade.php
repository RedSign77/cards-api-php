        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-8">
            <div class="prose dark:prose-invert max-w-none">
                ...
                <div class="text-sm text-gray-600 dark:text-gray-400 mb-8 space-y-1">
                    ...
                    <p><strong>Governing Law:</strong> Hungarian and European Union law (GDPR compliant)</p>
                </div>
                ...
                <section class="mb-8">
                    ...
                    <p class="mb-4 text-gray-700 dark:text-gray-300">
                        ...
                        <strong>Email:</strong> <a href="mailto:info@webtech-solutions.hu" class="text-blue-600 dark:text-blue-400 hover:underline">info@webtech-solutions.hu</a><br>
