...
use App\Filament\Resources\HexaResource\Pages;
use App\Models\Hexa;
use App\Models\Game;
use Filament\Forms;
...
class HexaResource extends Resource
{
    protected static ?string $model = Hexa::class;

    protected static ?string $navigationIcon = 'heroicon-o-cube';

    protected static ?string $navigationLabel = 'Hexas';

    protected static ?string $modelLabel = 'Hexa';

    protected static ?string $pluralModelLabel = 'Hexas';
    ...
    {
        return [
            'index' => Pages\ListHexas::route('/'),
            'create' => Pages\CreateHexa::route('/create'),
            'edit' => Pages\EditHexa::route('/{record}/edit'),
        ];
    }
